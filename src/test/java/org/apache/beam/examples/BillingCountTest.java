...
import efx.sup.translator.pipeline.TranslatorData.BillingCount;
import efx.sup.translator.pipeline.TranslatorData.ExtractBillingFn;
import efx.sup.translator.pipeline.TranslatorData.FormatAsTextFn;

/** Tests of WordCount. */
@RunWith(JUnit4.class)
public class BillingCountTest {
  ...
  public void testExtractWordsFn() throws Exception {
    ...
    PCollection<String> output =
        p.apply(Create.of(words).withCoder(StringUtf8Coder.of()))
            .apply(ParDo.of(new ExtractBillingFn()));
  ...
  public void testCountWords() throws Exception {
    ...
    PCollection<String> output =
        input.apply(new BillingCount()).apply(MapElements.via(new FormatAsTextFn()));
